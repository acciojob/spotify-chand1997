...
public class SpotifyController {
    ...
    public String createUser(@RequestParam(name = "name") String name,@RequestParam("mobile") String mobile){
        ...
        if(spotifyService.createUser(name, mobile)==null) return "Failure";
        return "Success";
    }
    ...
    public String createArtist(@RequestParam(name = "name") String name){
       ...
       if(spotifyService.createArtist(name)==null) return "Failure";
        return "Success";
    }
    ...
    public String createAlbum(@RequestParam(name = "title") String title,@RequestParam("artistName") String artistName){
       ...
       if(spotifyService.createAlbum(title,artistName)==null) return "Failure";
        return "Success";
    }

    @PostMapping("/add-song")
    public String createSong(@RequestParam("title") String title,@RequestParam("albumName") String albumName,
       ...
       if(spotifyService.createSong(title, albumName, length)==null) return "Failure";
        return "Success";
    }

    @PostMapping("/add-playlist-on-length")
    public String createPlaylistOnLength(@RequestParam("mobile") String mobile,
                                         @RequestParam("title") String title,@RequestParam("length") int length) throws Exception{
        ...
        if(spotifyService.createPlaylistOnLength(mobile, title, length)==null) return "Failure";
    ...
    public String createPlaylistOnName(@RequestParam("mobile") String mobile,
        ...
        //The creater of the playlist will be the given user and will also be the only listener at the time of playlist creation
        //If the user does not exist, throw "User does not exist" exception
        if(spotifyService.createPlaylistOnName(mobile, title, songTitles)==null) return "Failure";
        return "Success";
    }

    @PutMapping("/find-playlist")
    public String findPlaylist(@RequestParam("mobile") String mobile,
       ...
       if(spotifyService.findPlaylist(mobile, playlistTitle)==null) return "Failure";
        return "Success";
    }

    @PutMapping("/like-song")
    public String likeSong(@RequestParam("mobile") String mobile,
      ...
      if(spotifyService.likeSong(mobile, songTitle)==null) return "Failure";
        return "Success";
    }
